...
func HandleNewUser(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodPost {
		...
		if isexistNickName {
			...
			http.Error(w, "NickName is already take please choose anothere one !", http.StatusInternalServerError)
			return
		}
		...
		if isexistemail {
			...
			http.Error(w, "Email is already take please choose anothere one !", http.StatusInternalServerError)
			return
		}
