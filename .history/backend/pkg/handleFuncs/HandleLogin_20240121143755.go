...
func HandleLogin(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodPost {
		...
		err := database.QueryRow("SELECT Id, Password, Nickname,  Profile, FirstName, LastName   FROM Users WHERE Email=?", entredData.Email).Scan(&id, &storedPassword, &username, &imgUrl, )
		if err != nil {
