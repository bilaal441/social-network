...
const users = [
  {id: "user1", name: "Alice", nickname: generateNickname()},
  {id: "user2", name: "Bob", nickname: generateNickname()},
  {id: "user3", name: "Charlie", nickname: generateNickname()},
  {id: "user4", name: "David", nickname: generateNickname()},
  {id: "user5", name: "Emma", nickname: generateNickname()},
  {id: "user6", name: "Frank", nickname: generateNickname()},
  {id: "user7", name: "Grace", nickname: generateNickname() , ava},
];
