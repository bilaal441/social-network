...
import {validateEmail, isPasswordStrong} from "../helpers/helpers";
...
export default function Register({setShowRegisterForm}) {
  ...
  const registerHandler = (e) => {
    e.preventDefault();
    const formIsValid = validateEmail(emailValue) && isPasswordStrong(passwordValue) && isNotEmty(firstNameValue) && isNotEmty(firstNameValue)
