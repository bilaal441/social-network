...
const ChatComponent = () => {
  ...
  const fetchMoreMessages = () => {
    if (messages.length < 100) {
      ...
      const prevScrollHeight = prevScrollPosRef.current.scrollHeight; // Remember the scroll height before appending new messages
      ...
      setTimeout(() => {
        ...
        prevScrollPosRef.current.scrollTop += prevScrollPosRef.current.scrollHeight - prevScrollHeight;
      }, 1000);
    } else {
