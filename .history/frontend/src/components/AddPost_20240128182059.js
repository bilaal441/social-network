...
const AddPost = () => {
  ...
  const searchInputClasses =
    privacy === "almost" && searchInputTouch ? `${classes.invalid} ` : "";
          ...
          <>
            ...
            <ul>
              {suggestions.map((suggestion, index) => (
                <li key={index} onClick={followerClickHandler}>
                  <User name={suggestion.username} isLoggedIn={suggestion} />
                </li>
              ))}
            </ul>
          </>
