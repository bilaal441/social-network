...
const ChatComponent = () => {
  ...
  const chatScrollHandler = (e) => {
    ...
    if (percentageScrolledUp <= 10 && prevScrollPos < scrollTop) {
      // console.log(percentageScrolledUp, "percentageScrolledUp");
      throttle(fetchMoreMessages, 500);
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <ListGroup className="d-flex flex-column gap-4" ref={messageConatinerRef}>
