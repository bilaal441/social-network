  ...
  return (
    ...
    >
      <ul className={classes.actions}>
        <Action
          numberAction={group.NumberOfFollowers}
          actionName={"Members"}
          toggleAction={toggleAction}
          active={isActive}
        />
        <Action
          numberAction={group.NumberOfFollowing}
          actionName={"Events"}
          toggleAction={toggleAction}
          active={isActive}
        />
      ...
      <div>
        <ul>
          ...
          >
            ...
            {group[isActive] === "Events" &&
              group[isActive]?.map((event, i) => <EventList events={event} />)}
          </InfiniteScroll>
        </ul>
      </div>
    </MyModal>
