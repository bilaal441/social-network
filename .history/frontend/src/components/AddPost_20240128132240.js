...
const AddPost = () => {
  ...
  const [searchInputTouch, searchInputTouch ] = useState(false);
  ...
  const searchInputClasses = isRighprivacy ? `${classes.invalid} ` : "";
  ...
  return (
    <MyModal handleClose={handleClose} handleShow={handleShow} show={show}>
      <Form onSubmit={handleSubmit} className="py-3">
        ...
        <Form.Group controlId="formBasicText" className={searchInputClasses}>
