...
const ChatComponent = () => {
  ...
  const handleSendMessage = (e) => {
    ...
    if (newMessage.trim() !== "") {
      setMessages([
        ...
        ...messages, // Add new message at the beginning of the array
      ]);
      setNewMessage("");
    }
  };
  ...
  useEffect(() => {
    if (show && endMessageRef.current) {
      endMessageRef.current.scrollIntoView({behavior: "smooth"});
    }
  }, [show, messages]); // Scroll to the bottom when messages change or modal is shown
