...
const groups = [
  {
    ...
    description: "A group for people who love outdoor activities like hiking, camping, and cycling.",
    creator: "user1",
    members: ["user1", "user2", "user3"],
    invitations: [],
    requests: ["user4", "user5"],
    posts: [
      { id: 1, userId: "user1", content: "Check out this awesome hiking trail!", comments: [] },
      { id: 2, userId: "user2", content: "Who's up for a camping trip next weekend?", comments: [] }
    ]
  },
  {
    id: 2,
    title: "Book Lovers Club",
    description: "A group for avid readers to discuss their favorite books and authors.",
    creator: "user2",
    members: ["user2", "user6", "user7"],
    invitations: [],
    requests: [],
    posts: [
      { id: 1, userId: "user2", content: "Just finished reading 'To Kill a Mockingbird'. What a masterpiece!", comments: [] },
      { id: 2, userId: "user6", content: "Has anyone read '1984' by George Orwell? I'd love to discuss it.", comments: [] }
    ]
  }
];
...
const events = [
  {
    ...
    description: "Join us for an adventurous trek to the base camp of Mount Everest!",
  ...
  },
  {
    ...
    description: "Let's delve into the themes and characters of Harper Lee's classic novel.",
