      ...
      <div className="profile">
        ...
        <div>
          <ul>
            ...
            <Action numberAction={user.followers}   actionName={"Followers"} toggleAction={toggleAction} active={isActive} />
            <Action numberAction={user.following}   actionName={"Following"} toggleAction={toggleAction} active={isActive} />
