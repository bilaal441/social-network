...
const Profile = () => {
  ...
  const [activeUserActions, setActiveUserActions] = useState([]);
  ...
  const toggleActionModel = (active) => {
    setIsActive(active);
    setActiveUserActions(dummyUser[active]);
  };
  ...
  const toggleAction = (clickButton, e) => {
    ...
    setActiveUserActions(dummyUser[clickButton]);
    console.log(activeUserActions);
    handleShow();
  };
    ...
    <Container>
      <div className={classes.profile}>
        ...
        <ProfileActions
          ...
          activeUserActions={activeUserActions}
        />
